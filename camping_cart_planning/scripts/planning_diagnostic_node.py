...
class PlanningDiagnosticNode(Node):
    def __init__(self) -> None:
        ...
        self.msgs_topic = str(self.declare_parameter("msgs_topic", "/planning/messages").value)
        self.diagnostic_topic = str(
            self.declare_parameter("diagnostic_topic", "/planning/diagnostic").value
        )
        ...
        self._msgs_pub = self.create_publisher(AvgPlanningMsgs, self.msgs_topic, 10)
        ...
        self.get_logger().info(
            "planning_diagnostic: messages=%s diagnostic=%s period=%.2fs"
