...
public:
  ...
  : rclcpp::Node("local_path_extractor")
  {
    ...
    pub_local_path_ = create_publisher<nav_msgs::msg::Path>(output_topic_, local_path_qos);
...
private:
  ...
  void onGlobalPath(const nav_msgs::msg::Path::ConstSharedPtr msg)
  {
  ...
  void onTimer()
  {
    ...
    for (size_t i = begin; i <= capped_end; ++i) {
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<camping_cart_planning::LocalPathExtractorNode>());
  rclcpp::shutdown();
  return 0;
}
