...
_EXPECTED_DRIVER_ARRAYS = {
    ...
    # HH_260904 - The absolute 0.30 m front cutoff fits in the shortest
    # hardware profile; all channels therefore stay at level 1.
