...
| `bringup.launch.py sim:=true external_simulator:=true` | Full CAMROD graph driven by external physics odometry | Fake sensor contracts follow fresh `/odom`; external adapter may own raw platform status |
