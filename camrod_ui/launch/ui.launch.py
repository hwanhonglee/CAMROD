...
def _resolve_default_frontend_dir() -> str:
    ...
    source_frontend_dir = os.path.join(source_pkg_root, 'runtime', 'assets', 'frontend', 'build')
    if os.path.isdir(source_frontend_dir):
        return source_frontend_dir

    packaged_frontend_dir = os.path.join(share_dir, 'assets', 'frontend', 'build')
    if os.path.isdir(packaged_frontend_dir):
        return packaged_frontend_dir

    return os.path.join(share_dir, 'assets', 'web')
