...
public:
  ...
  int run()
  {
    ...
    if (!output_yaml_path_.empty()) {
      ...
      out << "# HHL_260624 - Generated by camrod_map area_exporter from semantic drop_zone areas, preserving OSM yaw_deg when provided.\n";
      out << "drop_zones:\n";
    ...
    if (!camping_sites_output_yaml_path_.empty()) {
      ...
      out << "# HHL_260623 - Generated by camrod_map area_exporter from semantic camping_site areas.\n";
      out << "camping_sites:\n";
      for (const auto & site : camping_sites) {
        out << "  - id: \"" << site.id << "\"\n";
