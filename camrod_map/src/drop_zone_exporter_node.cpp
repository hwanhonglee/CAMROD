...
{
public:
  // Implements `DropZoneExporterNode` behavior.
  ...
  int run()
  {
    ...
    if (!out.is_open()) {
      ...
      publishStatus(avg_msgs::msg::ModuleHealth::ERROR, "failed to open output yaml path");
      return 1;
    }
    ...
    publishStatus(avg_msgs::msg::ModuleHealth::OK, "drop zone yaml export completed");
    return 0;
  }
