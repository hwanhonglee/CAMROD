...
{
public:
  DBSCANBBoxNode() : Node("vanjee_dbscan_bbox_node")
  {
    // ---- 기본값 ----
    input_topic_  = this->declare_parameter<std::string>("input_topic", "/points_nonground");
    bbox_topic_   = this->declare_parameter<std::string>("bbox_topic", "/dbscan/bboxes");
