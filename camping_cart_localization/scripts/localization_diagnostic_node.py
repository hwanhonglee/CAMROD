...
class LocalizationDiagnosticNode(Node):
    def __init__(self) -> None:
        ...
        self.msgs_topic = str(
            self.declare_parameter("msgs_topic", "/localization/messages").value
        )
        self.diagnostic_topic = str(
            self.declare_parameter("diagnostic_topic", "/localization/diagnostic").value
        )
        ...
        self.topic_navsat = str(
            self.declare_parameter("topic_navsat", "/sensing/gnss/navsatfix").value
        )
        ...
        self.topic_diag = str(
            self.declare_parameter("topic_diag", "/localization/eskf/diagnostics").value
        )

        self._msgs_pub = self.create_publisher(AvgLocalizationMsgs, self.msgs_topic, 10)
        ...
        self.create_subscription(NavSatFix, self.topic_navsat, self._on_navsat, sensor_qos)
        self.create_subscription(
        ...
        self.get_logger().info(
            "localization_diagnostic: messages=%s diagnostic=%s period=%.2fs"
