...
- 2026-02-09: Bringup override config added at `camrod_bringup/config/localization/kimera_bridge.yaml`.
...
- 2026-02-09: Example launch:
  `ros2 launch camrod_localization localization.launch.py kimera_bridge_enable:=true kimera_bridge_param_file:=/home/hong/camrod_ws/src/camrod_bringup/config/localization/kimera_bridge.yaml`
...
## 2026-01-09 20:10
- HH_260109: Move robot_localization vendor path to camrod_localization/external per request.

## 2026-01-09 19:52
- HH_260109: Vendor robot_localization under camrod_localization/third_party.
