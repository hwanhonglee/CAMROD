...
def generate_launch_description():
    ...
    kimera_bridge_param_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory('camrod_localization'),
    ...
    module_checker_enable_arg = DeclareLaunchArgument(
        ...
        default_value='true',
        description='Enable localization module checker publisher',
    )
    ...
    ekf = Node(
        ...
        namespace=module_namespace,
        output='screen',
        parameters=[os.path.join(get_pkg_share('camrod_bringup'), 'config', 'localization', 'ekf.yaml')],
    ...
    health_monitor = Node(
        ...
        namespace=module_namespace,
        output='screen',
        parameters=[os.path.join(get_pkg_share('camrod_bringup'), 'config', 'localization', 'health_monitor.yaml')],
    )
    ...
    localization_checker = Node(
        ...
        parameters=[{
            ...
            'status_name': 'localization/checker',
            'check_period_s': 0.5,
    ...
    localization_diagnostic = Node(
        ...
        parameters=[{
            ...
            'topic_pose_cov': '/localization/pose_with_covariance',
            'topic_odom': '/localization/odometry/filtered',
            'topic_twist': '/localization/twist',
            'topic_wheel_odom': '/platform/wheel/odometry',
            'topic_diag': '/localization/eskf/diagnostic',
        }],
    )
...
# Implements `get_pkg_share` behavior.
