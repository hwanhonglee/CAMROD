    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'enable_body_near_dynamic_stop': LaunchConfiguration('cmd_vel_gate_body_near_dynamic_stop'),
                'body_near_side_lookahead_m': LaunchConfiguration('cmd_vel_gate_body_near_side_lookahead_m'),
                'body_near_rear_lookahead_m': LaunchConfiguration('cmd_vel_gate_body_near_rear_lookahead_m'),
                'body_near_maneuver_side_lookahead_m': LaunchConfiguration('cmd_vel_gate_body_near_maneuver_side_lookahead_m'),
                'body_near_maneuver_rear_lookahead_m': LaunchConfiguration('cmd_vel_gate_body_near_maneuver_rear_lookahead_m'),
