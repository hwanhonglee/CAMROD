...
public:
    ...
    std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros) override
  {
    ...
    // 260708 - Publish turn_direction tag windows as route arc-length ranges so
    ...
    const geometry_msgs::msg::PoseStamped & goal) override
  {
    ...
    // 260708 - Accumulate per-lanelet arc-length windows while building the
...
private:
  ...
  // 260708 - Layout: data[0] = total route length [m] (sync guard against the
