# Guest UI recall + usage complete — final accepted evidence
...
- B1~B13: `13/13 PASS`
- 전체 경과 시간: `7803.845 s`
- 전체 odometry 거리: `1722.789852 m`
- outbound: `2591.052 s`, `858.190109 m`
- return: `5212.793 s`, `864.599743 m`
- strict-validation 묶음: `1`개, 전체 사이트와 PNG/GIF/matrix/wheel hash 대조 완료
