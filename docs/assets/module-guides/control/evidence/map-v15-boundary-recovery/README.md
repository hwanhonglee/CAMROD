...
python3 camrod_bringup/scripts/visualization/render_automatic_recovery_results.py \
  --map lanelet2_maps.osm \
  --route docs/assets/module-guides/control/evidence/map-v15-boundary-recovery/route-retry.json \
  --reverse docs/assets/module-guides/control/evidence/map-v15-boundary-recovery/static-reverse-retry.json \
  --crab docs/assets/module-guides/control/evidence/map-v15-boundary-recovery/one-sided-crab.json \
