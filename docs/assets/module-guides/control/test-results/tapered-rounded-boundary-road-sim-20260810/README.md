...
<!-- HH_260810 - Preserve the historical map-v17 ROS run, exact contour overlay,
...
the map-v17 road active when recorded. It is not a geometric mock-up. It is also not physical
...
ROS_DOMAIN_ID=47 python3 camrod_bringup/scripts/automatic_route_recovery_probe.py \
  ...
  --output docs/assets/module-guides/control/test-results/tapered-rounded-boundary-road-sim-20260810/runtime-b2-recovery.json \
