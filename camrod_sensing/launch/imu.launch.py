...
Usage:
  ros2 launch camrod_sensing imu_only.launch.py

Examples:
  ros2 launch camrod_sensing imu_only.launch.py port:=/dev/ttyACM0
  ros2 launch camrod_sensing imu_only.launch.py params_file:=/absolute/path/to/microstrain_cv7.yaml
"""
...
def generate_launch_description():
    ...
    default_params_file = os.path.join(sensing_share, "config", "imu", "microstrain_cv7.yaml")
