...
Usage:
  # GQ7 only (no NTRIP)
  ros2 launch camrod_sensing imu_ntrip.launch.py use_ntrip:=false

  # GQ7 + NTRIP (recommended for RTK test)
  ros2 launch camrod_sensing imu_ntrip.launch.py use_ntrip:=true

Examples:
  ros2 launch camrod_sensing imu_ntrip.launch.py microstrain_port:=/dev/ttyACM1
  ros2 launch camrod_sensing imu_ntrip.launch.py microstrain_params:=/abs/path/microstrain_gq7.yaml
  ros2 launch camrod_sensing imu_ntrip.launch.py ntrip_params:=/abs/path/ntrip_client.yaml
"""
